...
const OnSubmit=async(e)=>{
  ...
  return (
    <section id="list" className='list'>
        ...
        <h5 className="list__outerdiv__header-text">कर्मचारी दर्ता तथा संशोधन फाराम</h5>
            <form className='list__form' onSubmit={OnSubmit}>
                <div className="list__form__item">
                <input type="text" onChange={handleChange} className='list__form__item__input' value={data.staff_name} name='staff_name' placeholder='कर्मचारीको नाम नेपालीमा' required/> 
                </div>
                <div className="list__form__item">
